...
import {
  downloadFile,
  generateTransactionAmountReport,
  getSettlementIds
...
const TransferSettlementReport = () => {
  ...
  const onDownloadChangeHandler = (e: any) => {
    ...
    generateTransactionAmountReport(user, {
  ...
  return (
    ...
    <VStack align="flex-start" w="full" h="full" p="3" mt={10}>
      <Stack>
        <Heading fontSize="2xl" fontWeight="bold" mb={6}>{t('ui.transfer_settlement_report')}</Heading>
      </Stack>
...
export default memo(TransferSettlementReport);

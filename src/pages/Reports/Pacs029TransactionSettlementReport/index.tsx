...
import { TransferSettlementReportHelper } from '@helpers/form';
import { zodResolver } from '@hookform/resolvers/zod';
import {
  downloadFile,
  generatePacsTransactionAmountReport,
  getSettlementIds
...
const initialFileName = 'NimbaPayT';

const Pacs029TransactionSettlementReport = () => {
  ...
  const schema = transferSettlementReport.schema;
  ...
  const onDownloadChangeHandler = (e: any) => {
    ...
    generatePacsTransactionAmountReport(user, {
  ...
  return (
    ...
    <VStack align="flex-start" w="full" h="full" p="3" mt={10}>
      <Stack>
        <Heading fontSize="2xl" fontWeight="bold" mb={6}>{t('ui.pacs_029_transaction_settlement_report')}</Heading>
      </Stack>
...
export default memo(Pacs029TransactionSettlementReport);
